...
const holidayData = {
    ...
    // EU Member States holidays for 2026 based on EMA/240605/2025 (CTIS)
    'BE': [
        // 2025 (OJ C, C/2024/7517, 20.12.2024)
        '2025-01-01',
        '2025-04-20',
        '2025-04-21',
        '2025-05-01',
    ...
    'BG': [
        ...
        // 2026 (EMA/240605/2025, CTIS)
        '2026-01-01', // New Year’s Day
        '2026-03-03', // National Holiday /Bulgaria’s Liberation from the Ottoman Empire
        '2026-04-10', // Good Friday
        '2026-04-11', // Holy Saturday
        '2026-04-12', // Easter Sunday
        '2026-04-13', // Easter Monday
        '2026-05-01', // Labour and International Worker’s Solidarity Day
        '2026-05-06', // Gergyovden (St. George’s Day), and the Bulgarian Army’s Day
        '2026-05-25', // Bulgarian Education and Culture, and Slavic Script Day
        '2026-09-07', // Unification Day
        '2026-09-22', // Independence Day
        '2026-12-24', // Christmas Eve
        '2026-12-25', // Christmas Days
        '2026-12-28', // Christmas Days
    ],
    ...
    'DK': [
        ...
        '2026-06-05', // Constitution Day (Denmark)
        '2026-12-24', // Christmas Eve
        '2026-12-25', // First Day Of Christmas
    ...
    'EE': [
        ...
        '2026-12-24', // Christmas Eve
        '2026-12-25', // Christmas Day
        '2026-12-26', // 2nd Day of Christmas
    ],
    ...
    'IE': [
        ...
        '2026-12-25', // Christmas Day
        '2026-12-28', // St Stephens Day
        '2026-12-29', // HPRA closed
        '2026-12-30', // HPRA closed
        '2026-12-31', // HPRA closed
    ],
    ...
    'EL': [
        ...
        '2026-03-25', // Greek Revolution Day
        '2026-04-10', // Good Friday
        '2026-04-12', // Easter Sunday
        '2026-04-13', // Easter Monday
        '2026-05-01', // Labour Day
        ...
        '2026-10-28', // Ohi Day
        '2026-12-25', // Christmas Day
        '2026-12-26', // Glorifying Mother of God
    ],
    ...
    'ES': [
        ...
        // 2026 (EMA/240605/2025, CTIS)
        '2026-01-01', // New Year
        '2026-01-06', // Epiphany Eve
        '2026-03-19', // St Joseph Day
        '2026-04-02', // Holy Thursday
        '2026-04-03', // Holy Friday
        '2026-05-01', // Labor Day
        '2026-05-02', // 2nd of May Holiday
        '2026-05-15', // St Isidore's Day
        '2026-07-25', // St James Day
        '2026-08-15', // Assumption Day
        '2026-10-12', // National Day of Spain
        '2026-11-02', // All Saints' Day
        '2026-11-09', // Our Lady of the Almudena
        '2026-12-07', // Constitution Day
    ...
    'FR': [
        ...
        '2026-04-06', // Easter Monday
        '2026-05-01', // Labour day
        '2026-05-08', // Second world war victory
        '2026-05-14', // Ascension Day
        '2026-05-25', // Pentecost Day
        '2026-07-14', // National Holiday
        '2026-08-15', // Assumption Day
        '2026-11-01', // All Saints’ Day
        '2026-11-11', // First world war armistice day
        '2026-12-25', // Christmas Day
    ],
    ...
    'HR': [
        ...
        '2026-06-22', // Anti-Fascist Resistance Day
        '2026-08-05', // Victory and Homeland Thanksgiving Day and the Day of Croatian Defenders
        '2026-08-15', // Assumption day
        '2026-11-01', // All Saints' Day
        '2026-11-18', // Remembrance Day for Homeland War Victims
        '2026-12-25', // Christmas Day
        '2026-12-26', // St. Stephen's Day
    ],
    ...
    'IT': [
        ...
        '2026-01-06', // Epiphany
        '2026-04-06', // Easter Monday
        '2026-04-25', // Liberation from nazi-fascism
        '2026-05-01', // Labour day
        '2026-06-02', // Republic day
        '2026-06-29', // Patron Saint Feast
        '2026-08-15', // Assumption Day
        '2026-11-01', // All Saints' Day
    ...
    'CY': [
        ...
        '2026-12-24', // Christmas Eve
        '2026-12-25', // Christmas Day
        '2026-12-26', // Next day of Christmas
    ],
    ...
    'LV': [
        ...
        '2026-05-05', // The postponed holiday
        '2026-06-23', // Midsummer's Eve
        '2026-06-24', // Saint Johan's Day
    ...
    'LT': [
        ...
        // 2026 (EMA/240605/2025, CTIS)
        '2026-01-01', // New Year's Day
        '2026-02-16', // Lithuanian State Restoration Day
        '2026-03-11', // Lithuanian Independence Restoration Day
        '2026-04-05', // Easter Sunday
        '2026-04-06', // Easter Monday
        ...
        '2026-07-06', // Statehood Coronation of King Mindaugas of Lithuania Day
        '2026-08-15', // The Assumption Day
        '2026-11-01', // All Saints' Day
        '2026-11-02', // All Souls' Day
        '2026-12-24', // Christmas Eve
        '2026-12-25', // Christmas Day
        '2026-12-26', // The Second Day of Christmas
    ],
    ...
    'MT': [
        ...
        '2026-08-15', // Feast of the Assumption Our Lady (Santa Marija)
    ...
    'PL': [
        ...
        '2026-05-03', // May 3rd Constitution Day
        '2026-05-24', // Pentecost Day
        '2026-06-04', // Corpus Christi Day
        '2026-08-15', // Assumption Day
        '2026-11-01', // All Saints Day
        '2026-11-11', // Independence Day
        '2026-12-24', // Christmas Eve' Day
        '2026-12-25', // Christmas
    ...
    'PT': [
        ...
        '2026-05-01', // Labour Day
        '2026-06-04', // Corpus Christi
        '2026-06-10', // Portugal's Day
        '2026-06-13', // Saint Antonio's Day
        '2026-06-19', // Corpus Christi
        '2026-08-15', // Assumption Day
        '2026-10-05', // Proclamation of the Republic Day
        '2026-11-01', // All Saint's Day
        '2026-12-01', // Independence Restoration Day
        '2026-12-08', // Immaculate Conception Day
        '2026-12-25', // Christmas Day
    ],
    ...
    'RO': [
        ...
        '2026-01-06', // Epiphany/Theophany
        '2026-01-07', // The Sobor of the Holy Prophet Jonh the Baptize
        '2026-01-24', // Unification Day
        '2026-04-07', // World Health Day
        '2026-04-10', // Orthodox Good Friday of Easter
        '2026-04-12', // Orthodox Easter Day
        '2026-04-13', // Orthodox Easter Monday
        '2026-05-01', // Labour Day
        '2026-05-31', // Orthodox Pentecost
        '2026-06-01', // Orthodox Pentecost Monday/Children's Day
        '2026-08-15', // Saint Mary's Day
        '2026-11-30', // Saint Andrew's Day
        '2026-12-01', // Romania’s National Day
        '2026-12-25', // Christmas Day
        '2026-12-26', // Second day of Christmas
    ],
    ...
    'SK': [
        ...
        '2025-12-26',
        // 2026 (EMA/240605/2025, CTIS)
        '2026-01-01', // The day of the establishment of the Slovak Republic
        '2026-01-06', // Epiphany
        '2026-04-03', // Good Friday
        '2026-04-06', // Easter Monday
        '2026-05-01', // Labour Day
        '2026-05-08', // Day of Victory over Fascism
        '2026-07-05', // St/ Cyril and St/ Methodius Day
        '2026-08-29', // Slovak National Uprising Day
        '2026-09-15', // Day of the Virgin Mary of the Seven Sorrows
        '2026-11-01', // All Saints Day
        '2026-11-17', // Day of the Fight for Freedom and Democracy
        '2026-12-24', // Christmas Eve
        '2026-12-25', // Christmas Day
        '2026-12-26', // Boxing Day/St. Stephen’s Day
    ],
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    function populateUIFromStrings() {
        ...
        if (footer && appStrings.footer) {
            ...
            const memberStates2026Link = '<a href="https://www.ema.europa.eu/en/documents/other/european-union-member-state-public-holidays-recorded-ctis-year-2026_en.pdf" target="_blank" rel="noopener">European Union Member State Public Holidays Recorded in CTIS, Year 2026 (EMA/240605/2025, 22 July 2025)</a>';
